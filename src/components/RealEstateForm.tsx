...
const DIFERENCIAIS_MAP: Record<string, string[]> = {
  ...
  'Depósito': ['apartamento', 'cobertura', 'casa', 'sobrado', 'conjunto', 'andar corporativo', 'galpão'],
  ...
  'Cerca Elétrica': ['casa', 'sobrado', 'sítio', 'terreno', 'galpão'],
  'Câmeras de Monitoramento': ['casa', 'sobrado', 'sítio', 'apartamento', 'cobertura', 'galpão'],
  'Alarme Monitorado': ['casa', 'sobrado', 'sítio', 'galpão'],
  'Portão Eletrônico': ['casa', 'sobrado', 'sítio', 'loja', 'galpão'],
  ...
  'Entrada Lateral': ['casa', 'sobrado', 'loja', 'galpão'],
  ...
  'Área de Carga e Descarga Coberta': ['galpão', 'loja'],
};
